...
int main(int argc, char** argv) {
    ...
    if (strcmp(argv[1], "sleep") == 0) { 
        ...
        openConnection(fd,"skynet.soe.ucsc.edu","7892");
        serialPrintf(fd, "{ \"id\":0, \"cam\":\"SlugCam1\",\"time\":%d,\"data\":{},\"type\":\"ping\"}\n", time(NULL));
        /*
        id: 0,
        cam: this.name,
        ...
        */
        ...
        openConnection(fd,"skynet.soe.ucsc.edu","7892");
        serialPrintf(fd, "{ \"id\":0, \"cam\":\"SlugCam1\",\"time\":%d,\"data\":{\"message\":\"Human!\"},\"type\":\"tag\"}\n", time(NULL));
        /*
        id: 0,
        cam: this.name,
        time: Math.floor((new Date()).getTime() / 1000),
